...
Facial Emotion Recognition on FER2013 Dataset Using a Convolutional Neural Network with 66.369% accuracy using 80-10-10 ratio for training-validation-test sets.
